...
class CrudClients(ICrud):
    def create(self):
        ...
        while True:
            ...
            dni=validar.cedula("Error: debe contener 10 dígitos y ser de nacionalidad ecuatoriana",23,4)
        ...
        gotoxy(15,10);print(yellow_color+"Está seguro de grabar el cliente? (s/n): ")
    ...
    def update(self):
        ...
        if client_update:
            ...
            gotoxy(4,13);print(yellow_color+"cliente actualizado exitosamente.")
            ...
            for invoice in invoices:
                if invoice["factura"] == invoice_number:
                    ...
                    if opcion == '1':
                        ...
                        gotoxy(7,14);opcion = validar.validar_fecha("Error: Solo numeros",30, 14)
                    ...
                    json_file.save(invoices)
                    gotoxy(24,15);print("Factura actualizada exitosamente.")
                    break
